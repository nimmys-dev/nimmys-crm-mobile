...
import '../../features/leads/todays_follow_up_screen.dart';
...
class NotificationService {
  ...
  /// caller passes.
  static GlobalKey<NavigatorState> navigatorKey = appNavigatorKey;
  ...
  static void _notificationRouting(NotificationPayload notification) {
    ...
    switch ((notification.route ?? "").trim()) {
      case "/leadDetailsScreen":
        navigator.push(commonRoute<void>(const LeadDetailsScreen()));
        break;
      case "/leadListScreen":
        navigator.push(LeadListScreen.route());
        break;
      case "/todaysFollowUpScreen":
        navigator.push(commonRoute<void>(const TodaysFollowUpScreen()));
        break;
      default:
        CustomLog.debug(
          NotificationService,
