...
class ApiUrls {
  ...
  static String closedLeads = "$_baseUrl/leads/closed";
  ...
  static String getTaskCounts = "$_baseUrl/dashboard/task-counts";
  ...
  static String getTasksByStaffId = "$_baseUrl/tasks-assigned";
}
