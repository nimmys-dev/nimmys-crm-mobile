...
class NotificationSessionManager {
  ...
  Future<void> clear() async {
    ...
    await Future.wait(<Future<void>>[
      prefs.deleteKey(_keyLastDeviceName),
      prefs.deleteKey(_keySosDeviceName),
      prefs.deleteKey(_keyPowerCutDeviceName),
      prefs.deleteKey(_keySpyModeDeviceName),
      prefs.deleteKey(_keyLatestType),
    ]);
  }
