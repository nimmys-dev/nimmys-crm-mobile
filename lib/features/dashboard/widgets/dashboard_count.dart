  ...
  List<StatItem> _buildMyDutyStats(UserRole role, DashboardCount? counts) {
    ...
    return [
      StatItem(
        ...
        tone: StatTone.red,
        route: AppRouteName.dutiesFiltered('ongoing_duty', 'my_tasks'),
      ),
      StatItem(
        label: 'Overdue Duty',
        value: overdue,
        ...
        tone: StatTone.ink,
        route: AppRouteName.dutiesFiltered('overdue_duty', 'my_tasks'),
      ),
      StatItem(
        label: 'Upcoming Duty',
        value: upcoming,
        ...
        tone: StatTone.red,
        route: AppRouteName.dutiesFiltered('upcoming_duty', 'my_tasks'),
      ),
  ...
  List<StatItem> _buildAllDutyStats(UserRole role, DashboardCount? counts) {
    ...
    return [
      StatItem(
        ...
        icon: Icons.fact_check_outlined,
        tone: StatTone.red,
        route: AppRouteName.dutiesFiltered('ongoing_duty', 'all_tasks'),
      ),
      StatItem(
        label: 'Overdue Duty',
        value: overdue,
        icon: Icons.event_busy_outlined,
        tone: StatTone.ink,
        route: AppRouteName.dutiesFiltered('overdue_duty', 'all_tasks'),
      ),
      StatItem(
        label: 'Upcoming Duty',
        value: upcoming,
        icon: Icons.schedule_rounded,
        tone: StatTone.red,
        route: AppRouteName.dutiesFiltered('upcoming_duty', 'all_tasks'),
      ),
      if (role.canAccessApprovals)
        StatItem(
          label: 'Approval Pending',
  ...
  List<StatItem> _buildMyLeadStats(LeadCounts? leadCounts) {
    ...
    return [
      StatItem(
        ...
        tone: StatTone.red,
        route: AppRouteName.leadsWithStatus('open_followup'),
      ),
      StatItem(
        ...
        tone: StatTone.ink,
        route: AppRouteName.leadsWithStatus('today_followup'),
      ),
      StatItem(
        ...
        tone: StatTone.ink,
        route: AppRouteName.leadsWithStatus('overdue_followup'),
      ),
      StatItem(
        ...
        tone: StatTone.red,
        route: AppRouteName.leadsWithStatus('upcoming_followup'),
      ),
    ];
  }
