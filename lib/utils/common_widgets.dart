...
import 'package:nimmys_crm/utils/app_button.dart';
import 'package:nimmys_crm/utils/app_button_style.dart';
import 'package:nimmys_crm/utils/app_colors.dart';
import 'package:nimmys_crm/utils/app_image.dart';
import 'package:nimmys_crm/utils/app_string.dart';
import 'package:nimmys_crm/utils/app_text_style.dart';
import 'package:nimmys_crm/utils/common_functions.dart';
    ...
    if (suffixIcon is String) {
      if (suffixIcon.toString().contains(".svg")) {
        return InkWell(
          ...
          child: SvgPicture.asset(
            ...
            colorFilter: AppColors.svg(
              suffixIconColor ?? AppColors.greyIconColor,
            ),
          ).paddingAll(15),
        );
      } else {
        return InkWell(
          ...
          child: Image.asset(
            suffixIcon,
            color: suffixIconColor ?? AppColors.greyIconColor,
          ).paddingAll(15),
        );
      }
  ...
  return InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(
      borderSide: BorderSide(
        color: focusColor ?? AppColors.secondaryColor,
        width: 1,
      ),
      borderRadius: BorderRadius.circular(borderRadius),
    ),
    errorBorder: OutlineInputBorder(
      borderSide: BorderSide(
        color: enableBorder == false ? Colors.transparent : Colors.red,
      ),
      borderRadius: BorderRadius.circular(borderRadius),
    ),
...
Widget commonCacheNetworkImage({
...
Widget iconsGridDesign(icon) {
  return Icon(
    icon,
    color: icon == CupertinoIcons.photo_on_rectangle
