...
class AppTextStyle {
  ...
  static TextStyle h3w600 = GoogleFonts.poppins(
  ...
  static TextStyle h4w500 = GoogleFonts.poppins(
  ...
  static TextStyle h5w500 = GoogleFonts.poppins(
    fontWeight: FontWeight.w500,
    color: AppColors.primaryTextColor,
    fontSize: 13.80,
  );
  ...
  /// Text Field & Dropdown
  static TextStyle textFiled = GoogleFonts.poppins(
    color: AppColors.primaryTextColor,
    fontSize: 14.72,
  );
